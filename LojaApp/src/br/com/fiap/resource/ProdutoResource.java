...
public class ProdutoResource {
	...
	public Response cadastrar(ProdutoTO produto, @Context UriInfo uriInfo) {
		...
		return Response.created(builder.build()).entity(produto).type(MediaType.APPLICATION_JSON).build() ;
	}
	...
	public Response atualizar(ProdutoTO produto, @PathParam("id") int id) {
		...
		return Response.ok().entity(produto).type(MediaType.APPLICATION_JSON).build();
	}		
